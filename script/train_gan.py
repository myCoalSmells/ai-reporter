...
def parse_arguments():
    ...
    parser = LitUnetGAN.add_model_specific_args(parser)
...
def main():
    ...
    model = LitUnetGAN(**vars(args))

    dm_train = LitUnalignedDM(src_dir=args.data_src_dir, tgt_dir=args.data_tgt_dir, 
    ...
    trainer = pl.Trainer.from_argparse_args(args, callbacks=callbacks, logger=logger, 
                                            log_every_n_steps=min(50, len(dl_train)))
